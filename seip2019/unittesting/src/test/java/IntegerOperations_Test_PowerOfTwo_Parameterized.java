...
/***
 * Dedicated class for the parameterized test
 * of the method powerOfTwo
...
public class IntegerOperationsTest_PowerOfTwo_Parameterized {
	...
	/***
	 * Parameters to check powerOfTwo for  power of 0
	 * and power of 1
	 */
  ...
  public void test_powerOfTwo() {
    Asssert.assertEquals(result_of_zero,mam.powerOfTwo(power_of_zero));
    Asssert.assertEquals(result_of_one,mam.powerOfTwo(power_of_one));
  }
